            ...
            <>
               <div id="home">
                   <div className="content">
                      ...
                      <button className="order"><i className="fa-solid fa-bag-shopping"></i> Order Pickup</button>
                      <button className="delivery"><i className="fa-solid fa-motorcycle"></i> Order Delivery</button>
                   </div>
                   <div className="image">
